...
function ProductTile({ singleProductTile }) {
    ...
    function handleNavigateToProductDtailsPage(getCurrentProductId){
    ...
    return (
        <div className="relative group border border-cyan-700 p-6 cursor-pointer">
            ...
            <button className="px-5 mt-5 w-full py-2 rounded-none bg-black text-white font-bold" onClick={()=>handleNavigateToProductDtailsPage(singleProductTile?.id)}>View Details</button>
        </div>
    );
}
